...
public class Constants {
    public static final String HOST_U = "http://u.meizu.com";
    ...
    public static final String PUSH_REGISTER = "http://u.meizu.com/subscription/registerWithSign";
    ...
    public static final String URL_CHECK_UPDATE = "http://u.meizu.com/appupgrade/check";
